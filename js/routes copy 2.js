      ...
      on: {
        ...
        pageInit: function (event, page) {
          ...
          if (platform === 'iOS') {
            ...
            <p>Adicione <strong>o aplicativo MMExpress</strong> à sua tela inicial para obter atualizações regulares. Toque em Compartilhar 
            ...
            conteudoInstall.innerHTML = `
            <p>Instale <strong>o aplicativo MMExpress</strong> para obter atualizações regulares. É rápido e ocupa menos armazenamento</p>
    ...
    },
    {
      ...
      on: {
        ...
        loginForm.addEventListener('submit', function(e) {
            ...
            if (userName == "admin@mmexpress.com.br" && userPassword == "1234") {
              //START Fazendo a requisição
                    app.dialog.close();
                    const token = "eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9..rFY2jHMwNKXqRoOq8E9E6ggkp_jdGTXm-GXKSZ3ljg8";
                    setCookie('userAuthToken', token, 5000);
              ...
              app.dialog.close();
              app.dialog.alert("Erro no login: " + ("Dados inválidos"), "Falha no Login");
            } 
        });
